...
```
cd existing_repo
git remote add origin https://gitlab.informatik.hs-augsburg.de/meryem.uenuevar/vqaserver.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.informatik.hs-augsburg.de/meryem.uenuevar/vqaserver/-/settings/integrations)
